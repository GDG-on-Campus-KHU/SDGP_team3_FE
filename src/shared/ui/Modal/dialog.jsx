  ...
  ({ className, children, ...props }, ref) => (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "flex flex-col fixed left-[50%] top-[50%] z-modal w-[90%] max-w-[600px] translate-x-[-50%] translate-y-[-50%] gap-4 bg-background px-4 py-5 shadow-lg rounded-2xl duration-200",
